...
if(isset($_POST['sim2'])){
	...
	if($exclusao){
		...
		if($linhas_afetadas>='1'){
			$_SESSION['mensagem']="Aluno ".$nome." removido com sucesso!.";
			$_SESSION['estilo'] = 'alert-success';
		}
		else{
			$_SESSION['mensagem']="Aluno ".$nome." não pode ser deletado.";
...
<form method="post" action="excluir_aluno.php">
	...
	<h3>Você realmente deseja excluir o aluno <?php echo $nome;?></h3>
