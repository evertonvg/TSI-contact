...
if(isset($_POST['sim2'])){
	$id=$_POST['id'];
	$sql = "DELETE FROM disciplina_professor WHERE id=".$id;
	...
	if($exclusao){
		...
		if($linhas_afetadas>='1'){
			...
			$_SESSION['mensagem']="Relação não pode ser deletada.";
...
?>
<form method="post" action="ExcluirDisciplinaProfessor.php">
	<input type="hidden" name="id" value="<?php echo $id; ?>">
	<a href="#" id="fechar">Fechar</a>
	<h3>Você realmente deseja excluir a relação?</h3>
